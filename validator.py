...
def clean_phone_number(phone: str, default_country_code: str = "91") -> str:
    ...
    - Prepends default country code if number doesn't have it (and seems to be a local number).
    - Checks for E.164 validity constraints (between 7 and 15 digits).
    Returns cleaned phone number as string, or None if invalid.
    """
    if not phone:
        return None
    ...
    # Assuming country code '91' (India) as default or user-defined
    # Typically Indian mobile numbers are 10 digits
